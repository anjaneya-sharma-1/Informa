...
class InformaApp:
    ...
    def _render_fact_checking_tab(self):
        ...
        **Submit any claim or headline for fact-checking:**
        ...
        The system will:
        - Search multiple fact-checking sources via specialized agents
        - Analyze text characteristics and credibility indicators using LangGraph orchestration
        - Provide a trustworthiness score with evidence and sources
        - Cross-reference with reliable news sources through RAG
        """)
